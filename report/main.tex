...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/Explicit_Euler.eps}
  \caption{FEM Solution using Explicit Euler method.}
  \label{fig:figures-Explicit_Euler-eps}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/Implicit_Euler.eps}
  \caption{FEM Solution using Implicit Euler method.}
  \label{fig:figures-Implicit_Euler-eps}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/Trapezoidal.eps}
  \caption{FEM Solution using Trapezoidal method.}
  \label{fig:figures-Trapezoidal-eps}
\end{figure}

Figure \ref{fig:figures-Explicit_Euler-eps}, \ref{fig:figures-Implicit_Euler-eps} and \ref{fig:figures-Trapezoidal-eps} shows the solution using the Explicit, Implicit and Trapezoidal method respectively with time step $k$ set to 0.1 and mesh size $h$ set to 7. All of the solution converge in this case with no significance performance overhead in the methods due to all methods have the same time complexity per updates and perform fixed size of update ($(t_F - t_0) / k$).


\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/Explicit_Euler-steps-error.eps}
  \caption{Step count error analysis with Explicit Euler method.}
  \label{fig:figures-Explicit_Euler-steps-error-eps}
\end{figure}


\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/Implicit_Euler-steps-error.eps}
  \caption{Step count error analysis with Implicit Euler method.}
  \label{fig:figures-Implicit_Euler-steps-error-eps}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/Trapezoidal-steps-error.eps}
  \caption{Step count error analysis with Trapezoidal method.}
  \label{fig:figures-Trapezoidal-steps-error-eps}
\end{figure}

Figure \ref{fig:figures-Explicit_Euler-steps-error-eps}, \ref{fig:figures-Implicit_Euler-steps-error-eps} and \ref{fig:figures-Trapezoidal-steps-error-eps} shows the effect of increasing the number of steps in the error of the solution measured in energy norm.
